    ...
    return (
        <div className="h-full max-w-screen-xl">
            <div className="header-text pb-4 pt-3">
                <h3 className="text-5xl font-semibold mt-6 mb-12 text-indigo-800 dark:text-indigo-100">Do you want to have an instagram account?</h3>
                <h4 className="text-3xl font-semibold text-indigo-900 my-4 dark:text-violet-300">Please sign up!</h4>
            </div>
            <form className="w-full max-w-xl mx-auto pt-8 h-full pb-40" onSubmit={handleSubmit(registerHandle)}>
                ...
                <div className=" md:items-center  flex flex-col">
                    <div className="md:w-1/3 mb-4 mr-44">
                        <label className="block text-gray-600 font-bold md:text-left mb-1 md:mb-0 pr-4 dark:text-gray-200" htmlFor="UserEmail">
                            Email
                        </label>
                    </div>
                    <div className="md:w-2/3 justify-center mb-4">
                        <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-indigo-500"
                            id="UserEmail" type="email" placeholder="abc@abc.com"
                            name="UserEmail"
